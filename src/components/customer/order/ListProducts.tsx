...
const ListProducts: FC<ListProductsProps> = ({ cartItems }) => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4">
      ...
      <div className="max-h-96 overflow-y-auto space-y-4 scrollbar-thin scrollbar-thumb-orange-500 scrollbar-track-gray-100">
        {cartItems.map((item) => (
          <div
            key={item.product.id}
          ...
          >
            ...
            <div className="flex-1 ml-4">
              ...
              <p className="text-sm text-gray-500 line-clamp-1 overflow-hidden">
